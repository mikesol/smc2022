...
\begin{enumerate}
  ...
  \item Existential quantification~\cite{Someone:00, Someone:09}, first introduced as a programming paradigm by Nigel Perry.
  % https://downloads.haskell.org/~ghc/latest/docs/html/users_guide/exts/existential_quantification.html#existentially-quantified-data-constructors
